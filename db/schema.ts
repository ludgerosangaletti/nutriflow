...
export const clients = sqliteTable(
  "clients",
  {
    ...
    whatsappActivationOptInPhone: text("whatsapp_activation_opt_in_phone"),
    whatsappActivationOptInSource: text("whatsapp_activation_opt_in_source"),
    whatsappActivationOptInVersion: text("whatsapp_activation_opt_in_version"),
    whatsappActivationOptInText: text("whatsapp_activation_opt_in_text"),
    whatsappActivationOptInRecordedBy: text("whatsapp_activation_opt_in_recorded_by"),
    whatsappActivationOptInRecordedByEmail: text("whatsapp_activation_opt_in_recorded_by_email"),
...
export const pushSubscriptions = sqliteTable(
  ...
  (table) => [
    ...
    index("push_subscriptions_client_email_idx").on(table.clientEmail),
  ],
);
...
export const nfTrainingExerciseMedia = sqliteTable(
  "nf_training_exercise_media",
  {
    ...
    posterByteSize: integer("poster_byte_size"),
    contentSha256: text("content_sha256"),
    posterSha256: text("poster_sha256"),
