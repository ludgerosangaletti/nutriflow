...
export const NUTRIFLOW_EDITOR_TOOLS: readonly EditorCatalogToolV1[] = Object.freeze([
  ...
  Object.freeze({ id: "recipes", label: "Receitas", insertionTarget: "meal-item", featureFlag: NUTRIFLOW_FEATURE_FLAGS.RECIPES, implementationState: "available" }),
  Object.freeze({ id: "meal-templates", label: "Modelos de refeição", insertionTarget: "meal", featureFlag: NUTRIFLOW_FEATURE_FLAGS.MEAL_TEMPLATES, implementationState: "available" }),
]);
