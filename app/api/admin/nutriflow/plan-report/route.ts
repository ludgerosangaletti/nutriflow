...
import { buildPlanReportPdf } from "../../../../../modules/nutriflow/reports/professional-pdf.ts";
import { loadRecipeSnapshots, loadReportLogo, NUTRITIONIST, pdfResponse } from "../../../../nutriflow/reporting";
...
export async function GET(request: Request) {
  ...
  return pdfResponse(bytes, `plano-alimentar-${client.id}-v${record.portal.plan.versionNumber}.pdf`);
}
