...
export async function GET(request: Request) {
  ...
  try {
    ...
    if (!context || !(await canUseNutriFlowFeature(context, clientId, NUTRIFLOW_FEATURE_FLAGS.TRAINING))) throw new NutriFlowApplicationError(NUTRIFLOW_ERROR_CODES.FEATURE_DISABLED, "Treino indisponÃ­vel.", 404);
